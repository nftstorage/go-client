...
type Deal struct {
	...
	ChainDealID *float32 `json:"chainDealID,omitempty"`
	// This is a timestamp in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format: YYYY-MM-DDTHH:MM:SSZ.
...
// GetChainDealID returns the ChainDealID field value if set, zero value otherwise.
func (o *Deal) GetChainDealID() float32 {
	if o == nil || o.ChainDealID == nil {
		var ret float32
		return ret
	}
	return *o.ChainDealID
}

// GetChainDealIDOk returns a tuple with the ChainDealID field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Deal) GetChainDealIDOk() (*float32, bool) {
	if o == nil || o.ChainDealID == nil {
		return nil, false
	}
	return o.ChainDealID, true
}
...
// SetChainDealID gets a reference to the given float32 and assigns it to the ChainDealID field.
...
func (o Deal) MarshalJSON() ([]byte, error) {
	...
	if o.ChainDealID != nil {
		toSerialize["chainDealID"] = o.ChainDealID
	}
